define([
    "jquery",
    "django",
    'django_comments_xtd/js/vendor-amd-2.0.8'
], function(__WEBPACK_EXTERNAL_MODULE_37__, __WEBPACK_EXTERNAL_MODULE_57__, __WEBPACK_EXTERNAL_MODULE_102__) {
...
var _django = __webpack_require__(57);
...
var _commentform = __webpack_require__(59);
  ...
  _createClass(Comment, [{
    ...
    value: function _get_username_chunk() {
      var username = this.props.data.user_name,
          moderator = "";
      // todo have in mind that i can just hardcode the profiles url here instead of modifying the Writeserializer
      // so that the username becomes a link
    ...
    value: function _get_right_div_chunk() {
      ...
      if (this.props.settings.allow_flagging) {
        ...
        if (this.state.removal) {
          ...
          // I modified the code so that a different {flagging html} is created if the user is logged in or not
          //  I couldn't have a next parameter since the logged in response is supposed to be rendered within
          //  a modal and since after the sign in you have a redirect response, the response must be a full page
          //  refresh, which isn't because I made it so that is rendered within the modal.
          //  Fuck!
          ...
          if (this.props.settings.is_authenticated) {
            ...
            flagging_html = _react2.default.createElement(
              'a',
              { className: 'mutedlink', href: url, 'data-toggle': 'modal', 'data-target': '#generic_modal' },
      ...
      if (this.props.settings.is_authenticated) {
        ...
        // if the user is a moderator or if the comment is his
        if (this.props.settings.can_moderate || current_user_id != '0' && current_user_id == this.props.data.user_id) {
    ...
    value: function action_like(event) {
      event.preventDefault();
      if (this.props.settings.is_authenticated) return this._post_feedback('like');else
        // if the user is unauthenticated nothing happens (a message is displayed with jquery)
        //  this was done to avoid the full page loads of the redirection pages
    ...
    value: function action_dislike(event) {
      event.preventDefault();
      if (this.props.settings.is_authenticated) return this._post_feedback('dislike');else
        // if the user is unauthenticated nothing happens (a message is displayed with jquery)
        //  this was done to avoid the full page loads of the redirection pages
        return window.location.href =
        // this.props.settings.login_url + "?next=" +
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'span',
                { className: 'bullet time-ago-bullet mutedlink', 'aria-hidden': 'true' },
                '\u2022'
              ),
              '\xA0',
              _react2.default.createElement(
...
var _commentbox = __webpack_require__(99);
...
var CommentForm = exports.CommentForm = function (_React$Component) {
  ...
  function CommentForm(props) {
    ...
    _this.fhelp = _react2.default.createElement(
      ...
      _django2.default.gettext("This field is required.")
    );
    return _this;
  }
  ...
  _createClass(CommentForm, [{
    ...
    value: function render_field_url() {
      if (this.props.is_authenticated) return "";
      var div_cssc = "form-group id_url",
          input_cssc = "form-control";
      if (this.state.reply_to > 0) {
        div_cssc += " form-group-sm";
        input_cssc += " input-sm";
    ...
    value: function render_form() {
      ...
      var btn_submit_class = "btn btn_zak_orange_01 ",
...
var _comment = __webpack_require__(101);
...
var CommentBox = exports.CommentBox = function (_React$Component) {
  ...
  _createClass(CommentBox, [{
      ...
      if (diff > 0) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { type: 'button', className: 'btn btn-default btn-xs btn_zak_orange_01',
    ...
    value: function componentDidMount() {
      this.load_comments();
      if (this.props.polling_interval) var polling = setInterval(this.load_count.bind(this), this.props.polling_interval);
      (0, _jquery2.default)(document).on("main_pjax_excluding_sidebar", function () {
        // console.log("caught main pjax in jsx")
