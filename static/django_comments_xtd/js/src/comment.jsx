  ...
  _get_right_div_chunk() {
    ...
    if (this.props.settings.allow_flagging)
    {
      ...
      if(this.state.removal) {
        ...
        flagging_html = (
          <a className="mutedlink" href={url} data-toggle="modal" data-target="#generic_modal">
        ...
        <div className="media-body">
          <div className="comment">
            <h6 className="media-heading">
                {new_label}&nbsp;<span className="author">{user_name}</span>
              &nbsp;<span className="bullet time-ago-bullet mutedlink" aria-hidden="true">•</span>
              &nbsp;<span className="mutedlink">{this.props.data.submit_date}</span>
              &nbsp;&nbsp;
