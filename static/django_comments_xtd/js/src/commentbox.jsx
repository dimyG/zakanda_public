...
export class CommentBox extends React.Component {
      ...
      return (
        <div className="alert alert-info">
          ...
          <div className="pull-right">
            <button type="button" className="btn btn-default btn-xs btn_zak_orange_01"
  ...
  componentDidMount() {
    ...
    if(this.props.polling_interval)
      var polling = setInterval(this.load_count.bind(this), this.props.polling_interval);
      $(document).on("main_pjax_excluding_sidebar", function(){
