/**
 Core Metronic script to handle the entire theme and core functions
 This file is used instead of the original layout.js
 There are some changes to the script so I have created a copy of it and apply the modifications to it
**/
var Layout = function () {
    ...
    var handle_sidebar_link_click = function(){
        // HAVE IN MIND: I have 2 options:
        // 1) events are bind to page-sidebar-menu and I don't replace this div
        // with ajax (pjax) so no left and main at once (or?). The page-sidebar-menu is a class of a list so in order to
        // avoid having a list as global element, I create a new global div with this class. The list has also this class
        // to be styled properly. So I bind the events to the div.
        // 2) events are bind to document and there is no need to create a new div with this class. But I don't
        // know if there are li > a.nav-toggle, li > a > span.nav-toggle outside of sidebar that don't need to
        // have this events. In this case I can stop evevent's propagation.

        $(document).on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {
        //$('div.page-sidebar-menu').on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {

        // The original code is the following line
        //$('.page-sidebar-menu').on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {
            // console.log('li > a.nav-toggle, li > a > span.nav-toggle');
    ...
    var handleSidebarMenu = function () {
        ...
        // TODO sidebar-search if I add sidebar-search then I need to handle the case in which the sidebar is updated
        // with pjax, which means the sidebar-search div is updated with a new one, and it's events are discarded.
        // So I could bind these events on document (and stop propagation if necessary)
    ...
    return {
        ...
        initSidebarAjax: function($state) {
            // This function is mine. It is executed after the sidebar is loaded with pjax.
            // console.log('>> Initiating Sidebar after it is updated with pjax...');
        ...
        bind_sidebar_menu_events: handle_sidebar_link_click
    };
